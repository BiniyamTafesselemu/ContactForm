...
const ContactForm = () => {  
  ...
  const handleRadioChange = (value: string) => {
    ...
    setError('query', { message: '' }); // Clear the error message for the query field
  };
  ...
  return (  
    <div className="min-h-screen flex items-center justify-center bg-lightgreen">  
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="w-full max-w-2xl bg-white p-4 rounded-2xl shadow-md">  
        ...
        <div className="flex flex-col mt-[20px]">  
          ...
          <div className="flex flex-col space-y-4 md:flex-row md:space-x-4 md:space-y-0">  
            <div className={`flex items-center border p-2 rounded-md w-full md:w-[300px] mt-[10px] ${selectedQuery === 'GeneralEnquiry' ? 'bg-lightgreen' : 'bg-white'} focus-within:border-2 focus-within:border-green-500`}>  
              <input  
                type="radio"  
                id="generalenquiry"  
            ...
            <div className={`flex items-center border p-2 rounded-md w-full md:w-[300px] mt-[10px] ${selectedQuery === 'SupportRequest' ? 'bg-lightgreen' : 'bg-white'} focus-within:border-2 focus-within:border-green-500`}>  
              <input  
                type="radio"  
                id="supportrequest"  
        ...
        <button className="mt-[40px] bg-mediumgreen w-full md:w-[600px] h-[50px] rounded-md text-white hover:bg-darkergray">Submit</button>  
      </form>  
    </div>  
  );  
};  
